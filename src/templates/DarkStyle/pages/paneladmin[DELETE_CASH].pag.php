<h4>Remover Moeda</h4>
	   <blockquote>
	   <form name="Delete_Cash" id="Delete_Cash">
...
<input type="button" value="Remover Moeda" onclick="CTM_Load('?pag=paneladmin&str=DELETE_CASH&cmd=true','Command','POST',BuscaElementosForm('Delete_Cash'));" />
</form>
	</blockquote>
	<div id="Command"></div>