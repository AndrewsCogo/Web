<div class="col2">
  ...
  {Bank_List}
    ...
    <div class="TabbedPanelsContent">Conta VIP s&atilde;o privilegios que as contas Free n&atilde;o contem.<br />
      ...
      <br />
      Cada tipo de conta contendo suas vantagens.<br />
      <br />
      <a href="javascript: void(EffectWeb)" onclick="CTM_Load('?pag=paneluser&option=BUY_VIP','conteudo','GET');">&raquo; Clique aqui para Compar o seu VIP</a>
    </div>
    <div class="TabbedPanelsContent">
      <table width="100%" border="0">
		...
		?>
					<tr>
          				<td>Mensagens Privadas</td>
          				<td><img src="images/icons/{Advantages#PM_System_Free}.png" style="border: none;" /></td>
          				<td><img src="images/icons/{Advantages#PM_System_VIP1}.png" style="border: none;" /></td>
          				<td><img src="images/icons/{Advantages#PM_System_VIP2}.png" style="border: none;" /></td>
                        <?php
						if(constant("VIP_Number") >= 3)
						{
						?>
                        <td><img src="images/icons/{Advantages#PM_System_VIP3}.png" style="border: none;" /></td>
                        <?php
						}
						if(constant("VIP_Number") >= 4)
						{
						?>
                        <td><img src="images/icons/{Advantages#PM_System_VIP4}.png" style="border: none;" /></td>
                        <?php
						}
						if(constant("VIP_Number") == 5)
						{
						?>
                        <td><img src="images/icons/{Advantages#PM_System_VIP5}.png" style="border: none;" /></td>
                        <? } ?>
           			</tr>
        <?
			}
      ...
      <?php /* 1.7.12 */ if($GLOBALS['_Panel']['Char']['Reset']['General']['Mode'] == 3) : ?>
      <h4 style="color: #000">Level para Resetar (Tabelado)</h4>
      <table width="100%" border="0">
        <tr>
