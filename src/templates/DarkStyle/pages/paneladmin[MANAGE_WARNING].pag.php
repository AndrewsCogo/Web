<h4> Gerenciar Aviso</h4>
	<blockquote>
<form name="Warning" id="Warning">
<table width="452" border="0">
  <tr>
    ...
    <td><input type="text" value="{Warning_Date} as {Warning_Time}" name="Title" id="Title" disabled="disabled" /></td>
      ...
      <tr>
        <td align="center" colspan="41"><textarea name="Text" id="Text" cols="60" rows="7">{Warning_Value}</textarea><br />&nbsp;</td>
      </tr>
      <tr>
        <td align="center" colspan="41"><input type="button" value="{Button} Aviso" onclick="CTM_Load('?pag=paneladmin&str=MANAGE_WARNING&cmd=true','Command','POST',BuscaElementosForm('Warning'));" /></td>
      </tr>
</table>
</form>
</blockquote>
