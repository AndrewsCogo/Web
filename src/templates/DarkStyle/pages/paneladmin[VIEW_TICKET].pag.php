...
<table width="452" border="0">
      ...
      <tr>
        <td align="center" colspan="41"><input type="button" value="Responder Ticket" onclick="CTM_Load('?pag=paneladmin&str=VIEW_TICKET&cmd=resp&id={Ticket_ID}','Command','POST',BuscaElementosForm('Manage_Ticket'));" />&nbsp;{Ticket_Define}{%DELETE_BUTTON%}</td>
      </tr>
	  </table>
	  </form>
	  </blockquote>
