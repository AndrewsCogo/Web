<h4 class="heading colr"> Editar Noticia</h4>
	<blockquote>
<form name="Edit_News" id="Edit_News">
<table width="452" border="0">
  <tr>
    <td>Titulo:</td>
    <td><input type="text" name="Title" value="{Notice_Title}" id="Title" /></td>
  </tr>
  <tr>
    <td>Data:</td>
    <td><input type="text" value="{Notice_Date} as {Notice_Time}" disabled="disabled" />&nbsp;<input type="checkbox" name="Update_Date" id="Update_Date" /> Alterar Data</td>
  </tr>
  <tr>
    <td>Potado Por:</td>
    <td><input type="text" value="{Notice_Char}" disabled="disabled" /></td>
  </tr>
  <tr>
    <td>Permitir Comentarios:</td>
    <td><input type="checkbox" name="Comments_Enable" id="Comments_Enable" {Notice_Comments} /></td>
  </tr>
      <tr align="center">
      ...
      <tr>
        <td align="center" colspan="41"><textarea name="Text" id="Text" cols="60" rows="7">{Notice_Text}</textarea><br />&nbsp;</td>
      </tr>
      <tr>
        <td align="center" colspan="41"><input type="button" value="Editar Noticia" onclick="CTM_Load('?pag=paneladmin&str=EDIT_NEWS&exec=true&id={Notice_ID}','Command','POST',BuscaElementosForm('Edit_News'));" /></td>
      </tr>
</table>
</form>
</blockquote>
