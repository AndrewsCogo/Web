...
<table width="452" border="0">
      ...
      <tr>
        <td align="center" colspan="41"><input type="button" value="Responder" onclick="CTM_Load('?pag=paneluser&str=VIEW_PAYMENT&cmd=true&id={Payment_ID}','Command','POST',BuscaElementosForm('Resp_Payment'));" /></td>
      </tr>
	  </table>
	  </form>
	  </blockquote>
