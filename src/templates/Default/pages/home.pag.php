...
?>
	<div class="col2">
        	<h4 class="heading colr">Not&iacute;cias do Servidor</h4>
...
?>
	<div class="col2">
        	<h4 class="heading colr">Not&iacute;cias do F&oacute;rum</h4>
...
?>
        <div class="col2">
        	<h4 class="heading colr">Top Reset / Master Reset</h4>
...
?>
        <div class="col2">
        	<h4 class="heading colr">Top Reset Diario / Semanal / Mensal</h4>
...
?>
        <div class="col2">
        	<h4 class="heading colr">Top PK / Hero</h4>
...
?>
        <div class="col2">
        	<h4 class="heading colr">Top Guild</h4>
...
?>
        <div class="col2">
        	<h4 class="heading colr">ScreenShots</h4>
